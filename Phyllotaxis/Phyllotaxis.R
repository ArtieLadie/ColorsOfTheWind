...
# Slightly modified from https://fronkonstin.com/2015/12/14/phyllotaxis-by-shiny/
...
shinyApp(
  ui = fluidPage(
    ...
    fluidRow(
      column(3,
             wellPanel(
               colourInput("col",label = "Colour of points:", "white"),
               colourInput("bac", label = "Background colour:", "black"),
